<x-guest-layout>
    <div class="max-w-2xl mx-auto  sm:p-6 lg:p-1">
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <x-text-input id="naam" class="block mt-1 w-full" type="text" name="naam" :required  /> 
            ...
            <x-text-input id="geboortedatum" class="block mt-1 w-full" type="date" name="geboortedatum" required  /> 
